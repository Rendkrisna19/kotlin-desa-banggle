...
INSERT INTO `pengajuan` (`id_pengajuan`, `username`, `nama_pemohon`, `nik_pemohon`, `jenis_surat`, `keterangan`, `keperluan`, `tanggal_pengajuan`, `status_rtrw`, `catatan_rtrw`, `tanggal_rtrw`, `status_admin`, `catatan_admin`, `tanggal_admin`, `status_akhir`, `catatan_sekdes`, `tanggal_sekdes`, `status`, `catatan`, `dokumen_hasil`, `dokumen_drive_url`) VALUES
(1, 'rahma', 'rahma', '1232321412412424', 'Pembuatan KIA', 'Pengajuan dari Aplikasi - Pembuatan KIA', 'Pembuatan KIA', '2026-07-14 16:49:42', 'Menunggu', NULL, NULL, 'Menunggu', NULL, NULL, 'Menunggu', NULL, NULL, 'pending', NULL, NULL, NULL),
(2, 'rahma', 'rahma', '1312312323454554', 'Permohonan KTP', 'Pengajuan dari Aplikasi - Permohonan KTP', 'Permohonan KTP', '2026-07-14 16:52:33', 'Menunggu', NULL, NULL, 'Menunggu', NULL, NULL, 'Menunggu', NULL, NULL, 'pending', NULL, NULL, NULL);
